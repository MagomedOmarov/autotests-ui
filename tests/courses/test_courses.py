...
class TestCourses:
  ...
  def test_create_course(self, courses_list_page: CoursesListPage,
    ...
    create_course_page.image_upload_empty_view.check_visible(
    ...
    create_course_page.image_upload_empty_view.upload_image(
  ...
  def test_edit_course(self, create_course_page: CreateCoursePage,
    ...
    create_course_page.create_course_form.fill(title="Playwright + Python",
